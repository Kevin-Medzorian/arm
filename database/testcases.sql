...
INSERT INTO Store values('test_store_2', 'test_password_2', 10000001, 10000001, '234 Main St.', 'Pluto', 'CA', '173205');

Insert into Customer values('test_customer_2', 'test_password_2', 10000001);
